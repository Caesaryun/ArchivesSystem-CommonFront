		...
		<div class="msg-box" ref="msg-box">
		      ...
		      >
		        <div class="user-head">
				 ...
				 <img  src="../assets/img/high-2.jpeg" height="40" width="40"  :title="i.username">
  ...
  export default {
    data() {
      return {
        ...
        username: this.$store.getters.getUser.username, // 当前用户昵称
        avatar:'../assets/img/high-2.jpeg', // 当前用户头像
        list: [], // 聊天记录的数组
    ...
    methods: {
      ...
      initWebSocket() {
        ...
        if (window.WebSocket) {
          ...
          var url = 'ws://' + serverHot + ':8080' + '/ArchivesSystem/groupChat/' + sip + '/' + this.userId; // `ws://127.0.0.1/9101/groupChat/10086/聊天室`
